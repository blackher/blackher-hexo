---
title: maxwell mysql 的timestamp类型时区正确
date: 2019-09-09 17:31:38
tags:
---
...
``` bash
$vim  src/main/java/com/zenesk/maxwell/schema/columndef/ColumnDef
...
### 新建TimeStampColumnDef TimeStampFormatter 文件 

#### 按照 DateTimeColumnDef 生成  TimeStampColumnDef 文件  修改最后几行
